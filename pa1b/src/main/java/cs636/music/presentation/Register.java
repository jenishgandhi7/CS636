...
//					+ "values('" + id + "','" + firstname + "','" + lastname + "','" + email + "','" + company_name + "','" + add1 + "','" + add2 + "','" + city + "','" + state + "','" + zip + "','" + country + "','" + CC_type + "','" + CC_Number +  "','" + CC_Exp_date+"')");
			...
			while (rset.next()) {
				...
				System.out.println("Company Name: " + rset.getString(5));
				System.out.println("Address 1: " + rset.getString(6));
				System.out.println("Address 2: " + rset.getString(7));
				System.out.println("City: " + rset.getString(8));
				System.out.println("State: " + rset.getString(9));
				System.out.println("Zip: " + rset.getString(10));
				System.out.println("Country: " + rset.getString(11));
				System.out.println("Credit Card Type: " + rset.getString(12));
				System.out.println("Credit Card No: " + rset.getString(13));
				System.out.println("Credit Card Exp: " + rset.getString(14));
				System.out.println("*******************************************************");
			}
			System.out.println("\n");
